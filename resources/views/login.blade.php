...
<head>
    ...
    <title>Kelola Surat | Login</title>
                            ...
                            <form method="POST" action="/login" class="pt-3">
                                ...
                                <div class="mt-3">
                                    <input type="submit" value="Login"
                                        class="btn btn-block btn-gradient-primary btn-lg font-weight-medium auth-form-btn" style="background: linear-gradient(to right, #50623A, #789461);">
                                </div>
